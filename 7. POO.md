...
doc :  Recibirá una cadena para documentar el atributo. (doc = documentación)
        ...
        class Usuario():
            ...
            #Ahora el metodo que nos permitirá usar como propiedad el set, set=entrada
              ...
              @nombreLista.setter
              def nombreLista(self,nombreFolio): #noten tiene el mismo nombre que el property, no importa porque uno me permitirá sacar información y otro meter información
                self.__nombre, self.__folio = nombreFolio.split(' ') #con split le estamo diciendo que lo que este antes del espacio lo guarde en nombre y después en folio


        #Instanciamos
        usuario1=Usuario('Juan', 'a4s5s')

        #Usamos la propiedad de salida, nota ya no tenemos que llamarla como función
        print(usuario1.nombreLista)

        #Ahora usamos la propiedad set
        usuario1.nombreLista='Ángel D54FD'  #Separará por el espacio el nombre y apellido y lo reasignará a las variables
